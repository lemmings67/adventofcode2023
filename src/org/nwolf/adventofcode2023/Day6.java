...
public class Day6 {
    ...
    public boolean isWinningCombination(int holding_time, int distance, int max_time) {
        int speed = holding_time;
        int remaining_time = max_time - holding_time;

        int distance_reached = speed*remaining_time;

        if (distance_reached > distance) return true;
